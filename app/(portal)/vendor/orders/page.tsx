...
// Components
import PageHeader from "@/components/portal/vendor/orderspage/PageHeader";
import SearchAndFilters from "@/components/portal/vendor/orderspage/SearchAndFilters";
import OrderTable from "@/components/portal/vendor/orderspage/OrderTable";
import EmptyState from "@/components/portal/vendor/orderspage/EmptyState";
import OrderDetailModal from "@/components/portal/vendor/orderspage/OrdersDetailModel";
import Pagination from "@/components/portal/vendor/orderspage/Pagination";
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      ...
      try {
        ...
        const endpoint = `/api/orders/vendor?${queryParams.toString()}`;
